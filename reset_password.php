...
<body>
    <div class="opener">
        <div class="verticle-middle">
            ...
            <div class="title verticle-middle"> <span class="small" id="info">Password Reset:</span>Please enter your reset code below
                <br>
                <br>
                <input type="text" id="reset-code" name="reset-code" placeholder="Password Reset Code" required />
                <button id="reset-submit-btn" style='height:auto;padding:5px;' type="submit">Reset Password</button>
            </div>
        </div>
    </div>
