...
$vendor = 2;
$email = "@handymark.com";
$description = "We manufacture quality motion eabling devices and systems for all robotics and industrial applications.";
$featured_title = "2-Wire Motor 393";
$featured_description = "Get a move on with the 2-Wire Motor.  Use different gear configurations to both increase it rotations per minute or it torque, and power it directly from your VEX Cortex Microcontroller.  Your robot may have brains, but does it have brawn?";
$featured_pid = 11;
$slogan = "<h1>Cheap and Dirty Solutions for the Roboticist on a Budget</h1>";
